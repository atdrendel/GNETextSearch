...
{
    NSString *path = [GNETextSearchTestResourcesBundle() pathForResource:@"words-beginning-with-A" ofType:@"txt"];
...
- (NSDictionary *)bibleDictionary
{
    ...
    dispatch_once(&onceToken, ^{
        NSString *path = [GNETextSearchTestResourcesBundle() pathForResource:@"bible" ofType:@"archive"];
        NSParameterAssert(path);
        NSError *error = nil;
