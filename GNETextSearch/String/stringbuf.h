...
extern tsearch_stringbuf_ptr tsearch_stringbuf_init(void);
...
/// the null terminator.
extern tsearch_stringbuf_ptr tsearch_stringbuf_init_with_cstring(const char *cString, const size_t length);

extern void tsearch_stringbuf_free(tsearch_stringbuf_ptr ptr);

/// Returns the length of the mutable string. The length does not include space for a null terminator.
extern size_t tsearch_stringbuf_get_len(tsearch_stringbuf_ptr ptr);
...
extern char tsearch_stringbuf_get_char_at_idx(tsearch_stringbuf_ptr ptr, size_t index);

/// Appends the specified C char array into the mutable string. Returns 1 if successful, otherwise 0.
/// The length parameter refers to the number of chars in cString, but should not include
/// the null terminator.
extern result tsearch_stringbuf_append_cstring(tsearch_stringbuf_ptr ptr, const char *cString, const size_t length);
