...
extern bool GNEIntegerCountedSetContainsInteger(GNEIntegerCountedSetPtr ptr, GNEInteger integer);
...
extern result GNEIntegerCountedSetCopyIntegers(GNEIntegerCountedSetPtr ptr, GNEInteger **outIntegers, size_t *outCount);

/// Adds the specified integer to the counted set. Returns 1 if successful, otherwise 0.
extern result GNEIntegerCountedSetAddInteger(GNEIntegerCountedSetPtr ptr, GNEInteger integer);
...
extern result GNEIntegerCountedSetRemoveInteger(GNEIntegerCountedSetPtr ptr, GNEInteger integer);

/// Removes all of the integers from the counted set.
extern result GNEIntegerCountedSetRemoveAllIntegers(GNEIntegerCountedSetPtr ptr);

/// Adds each integer and its count in the other counted set to specified set.
extern result GNEIntegerCountedSetUnionSet(GNEIntegerCountedSetPtr ptr, GNEIntegerCountedSetPtr otherPtr);
...
extern result GNEIntegerCountedSetIntersectSet(GNEIntegerCountedSetPtr ptr, GNEIntegerCountedSetPtr otherPtr);

/// Removes each integer in the other counted set from the specified set, if present.
extern result GNEIntegerCountedSetMinusSet(GNEIntegerCountedSetPtr ptr, GNEIntegerCountedSetPtr otherPtr);
