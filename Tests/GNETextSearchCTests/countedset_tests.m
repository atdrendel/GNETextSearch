...
{
    NSString *path = [GNETextSearchTestResourcesBundle() pathForResource:@"random-integers-100000-1"
                                                                   ofType:@"txt"];
...
{
    NSString *path = [GNETextSearchTestResourcesBundle() pathForResource:@"random-integers-100000-2"
                                                                   ofType:@"txt"];
    NSString *string = [NSString stringWithContentsOfFile:path encoding:NSUTF8StringEncoding error:nil];
    NSArray *stringArray = [string componentsSeparatedByString:@","];
    NSMutableArray *numbers = [NSMutableArray array];
